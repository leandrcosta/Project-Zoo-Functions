...
Este projeto foi desenvolvido durante o modulo de Fundamentos, inicio do Curso da Trybe 🚀

O projeto tem por objetivo a avaliação e prática dos conhecimentos adquiridos durante o modulo, visando o cumprimento do requisitos solicitados pela mesma.
...
1. Clone o repositório
  * `git clone git@github.com:leandrcosta/Project-Zoo-Functions.git`
